      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<ol class="breadcrumb">
				  ...
				  <li><a href="http://www.zcw.com/managers/permission/permission.jsp">许可管理</a></li>
				  <li class="active">新增</li>
				</ol>
			<div class="panel panel-default">
              <div class="panel-heading">许可新增表单<div style="float:right;cursor:pointer;" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-question-sign"></i></div></div>
        ...
        <script type="text/javascript">
            ...
            $("#insertBtn").click(function(){
            	...
            	if(name.val() == ""){
            		...
            		$.ajax({
                		type:"POST",
                		url:"/managers/permission/insert.do",
                		data:{
                			"name":name.val(),
                			"url":$("#url").val(),
                			"pid":"${param.id}"
                		...
                		success:function(result){
                			...
                			if(result.success){
                				layer.msg("许可信息添加成功！",{time:1500, icon:6}, function(){
                					window.location.href = "http://www.zcw.com/managers/permission/permission.jsp";
                				});
                			}else{
                    			layer.msg("许可信息保存失败！",{time:1500, icon:5, shift:6});
                    		}
                		 }
                		});
            		}
