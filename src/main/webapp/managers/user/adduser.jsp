      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<ol class="breadcrumb">
				  ...
				  <li><a href="http://www.zcw.com/managers/user/user.jsp">用户管理</a></li>
				  <li class="active">新增</li>
				</ol>
			<div class="panel panel-default">
              <div class="panel-heading">用户新增表单<div style="float:right;cursor:pointer;" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-question-sign"></i></div></div>
	...
	<script src="../../jquery/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("#insertBtn").click(function(){
            	...
            	if(loginacct.val() == ""){
            		layer.msg("登录的账号不能为空！",{time:1500, icon:5, shift:6},function(){
            			loginacct.focus();
		    		});
            	}else{
            		$.ajax({
                		type:"POST",
                		url:"/managers/insert.do",
                		data:{
                		...
                		success:function(result){
                			...
                			if(result.success){
                				layer.msg("用户信息保存成功！",{time:1500, icon:5, shift:6});
                				window.location.href="http://www.zcw.com/managers/user/user.jsp";
                			}else{
