      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
              <div class="panel-heading">资质新增表单<div style="float:right;cursor:pointer;" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-question-sign"></i></div></div>
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					<label for="exampleInputPassword1">资质名称</label>
					<input type="text" class="form-control" id="name" placeholder="请输入资质名称">
				  </div>
            	...
            	if(name.val() == ""){
            		...
            		$.ajax({
                		...
                		success:function(result){
                			...
                			if(result.success){
                				layer.msg("资质信息保存成功！",{time:1500, icon:6, shift:6});
                				window.location.href="http://www.zcw.com/managers/cert/cert.jsp";
                			}else{
                    			layer.msg("资质信息保存失败！",{time:1500, icon:5, shift:6});
                    		}
                		 }
                		});
            		}
