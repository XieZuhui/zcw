                ...
                <ul style="padding-left:0px;" class="list-group">
                    ...
                    <li class="list-group-item tree-closed">
                        ...
                        <ul style="margin-top:10px;display:none;">
                            ...
                            <li style="height:30px;">
                                <a href="javascript:void(0);" onclick="loadHtml(this)"><i class="glyphicon glyphicon-king"></i>
                                    <input name="path" type="hidden" value="role1.html"/> 角色维护</a>
                            </li>
                            <li style="height:30px;">
                                <a href="javascript:void(0);" onclick="loadHtml(this)" ><i class="glyphicon glyphicon-lock"></i>
                                    <input name="path" type="hidden" value="permission1.html"/> 许可维护</a>
                            </li>
                        </ul>
                    </li>
                    <li class="list-group-item tree-closed">
