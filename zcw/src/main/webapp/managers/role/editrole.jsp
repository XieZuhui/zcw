      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
              <div class="panel-heading">角色表单<div style="float:right;cursor:pointer;" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-question-sign"></i></div></div>
	...
	<script src="../../jquery/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("#editBtn").click(function(){
            	var name = $("#name");
            	if(name.val() == ""){
            		layer.msg("角色信息不能为空！",{time:1500, icon:5, shift:6},function(){
            			name.focus();
		    		});
            	}else{
            		$.ajax({
                		type:"POST",
                		url:"/managers/role/update.do",
                		data:{
                			"name":name.val(),
                			"id":"${role.id}"
                		},
                		...
                		success:function(result){
                			...
                			if(result.success){
                				layer.msg("角色信息修改成功！",{time:1500, icon:6, shift:6});
                				window.location.href="http://www.zcw.com/managers/role/role.jsp?pageno=${param.pageno}";
                			}else{
                    			layer.msg("角色信息修改失败！",{time:1500, icon:5, shift:6});
                    		}
                		 }
                		});
            		}
